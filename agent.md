...
- **项目**: AgentID-Chain
- **描述**: AI Agent 分布式身份与权限网关（v2.0.1 混合存储 + 四种接入范式）
- **需求基线**: [docs/AgentID-Chain-技术文档-v2.0.1.md](docs/AgentID-Chain-技术文档-v2.0.1.md)
- **架构规范**: [docs/architecture.md](docs/architecture.md)（5 层分层 + 依赖倒置）
- **任务管理**: 使用 LRA
