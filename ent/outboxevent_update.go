...
func (_u *OutboxEventUpdate) SetStatus(v uint8) *OutboxEventUpdate {
...
func (_u *OutboxEventUpdate) SetNillableStatus(v *uint8) *OutboxEventUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
func (_u *OutboxEventUpdate) AddStatus(v int8) *OutboxEventUpdate {
...
func (_u *OutboxEventUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedStatus(); ok {
		_spec.AddField(outboxevent.FieldStatus, field.TypeUint8, value)
	}
...
// SetStatus sets the "status" field.
func (_u *OutboxEventUpdateOne) SetStatus(v uint8) *OutboxEventUpdateOne {
	_u.mutation.ResetStatus()
	_u.mutation.SetStatus(v)
	return _u
}
...
// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *OutboxEventUpdateOne) SetNillableStatus(v *uint8) *OutboxEventUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
// AddStatus adds value to the "status" field.
func (_u *OutboxEventUpdateOne) AddStatus(v int8) *OutboxEventUpdateOne {
	_u.mutation.AddStatus(v)
	return _u
}
